...
export function POSClient({ cashierName }: POSClientProps) {
  ...
  return (
    <POSLayout cashierName={cashierName}>
      ...
      {/* 2. THE SLIDING REGISTER (Desktop Sidebar / Mobile Overlay) */}
      <AnimatePresence>
        {isCartOpen && (
          <>
