...
interface Product {
  id: string
  name: string // FIX: Directly typed from the DB
...
export function InventoryClient({ initialData, taxonomy }: InventoryClientProps) {
  ...
  // FIX: Stripped out the old computedName logic. Now filters directly against product.name
                  ...
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                        <div>
                          {/* FIX: Reading directly from product.name */}
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="relative w-12 h-12 rounded-lg border border-border bg-card overflow-hidden flex items-center justify-center shadow-sm">
                            {mainImage ? (
                              <Image src={mainImage} alt={product.name} fill className="object-cover group-hover:scale-110 transition-transform duration-500" unoptimized />
                            ) : (
